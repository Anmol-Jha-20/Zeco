...
import HeatExchangerApplicationImage from "../../../assets/ApplicationImageTwo.png";

const SmartAHUApplication = () => {
  const applications = [
    "Smart Buildings / Green-Certified Offices",
    "Hospitals (OTs, ICUs, Isolation Rooms)",
    "Pharmaceutical Cleanrooms & Labs",
    ...
    "Hotels & Hospitality (Banquet Halls, Kitchens)",
    "Cold Storage & Packaging Zones",
  ];
        ...
        <div className="max-w-4xl ml-6">
          ...
          <motion.div className="mb-12" variants={fadeInVariants}>
            <h3 className="text-xl md:text-2xl text-gray-600 mb-8 font-medium">
              "Ready to Upgrade Your Air Handling Experience?"
            </h3>
            ...
            <motion.p
              ...
              variants={fadeInVariants}
            >
              Choose Smart AHU for intelligent climate control, uncompromising
              air quality, and future-ready automation. Contact our experts
              today to customize your solution or schedule a live demo.
            </motion.p>
          </motion.div>
...
export default SmartAHUApplication;
