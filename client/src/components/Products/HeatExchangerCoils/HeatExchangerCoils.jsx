        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <p>
                  At Zeco Aircon, we redefine heat transfer efficiency with our
                  AHRI 410-certified Heat Exchangers—engineered for precision,
                  reliability, and performance. Designed to deliver superior
                  indoor thermal comfort, these high-performance units ensure
                  seamless heat transfer between fluids without
                  cross-contamination.
                </p>
