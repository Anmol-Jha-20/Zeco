...
import HeatExchangerApplicationImage from "../../../assets/ApplicationImageOne.png";

const AirDistributionApplication = () => {
  const applications = [
        ...
        <div className="max-w-4xl ml-6">
          ...
          <motion.div className="mb-12" variants={fadeInVariants}>
            <h3 className="text-xl md:text-2xl text-gray-600 mb-8 font-medium">
              "Ready to Upgrade Your Air Distribution System?"
            </h3>
            ...
            <motion.p
              ...
              variants={fadeInVariants}
            >
              Partner with Spire AirTech for precision-engineered ductwork
              solutions tailored to your project. Contact our team today for
              design consultation, custom quotes, or technical assistance.
            </motion.p>
          </motion.div>
...
export default AirDistributionApplication;
